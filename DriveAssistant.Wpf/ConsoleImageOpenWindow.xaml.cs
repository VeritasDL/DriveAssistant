...
public partial class ConsoleImageOpenWindow : Window
{
    ...
    private void BrowseImage_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            Filter = "Console Images (*.img;*.bin;*.cue;*.raw;*.imgc;*.iso;*.wbfs;*.zip;*.wud;*.wux;*.gcm;*.gdi;*.cdi;*.cim;*.vmu;*.vms;*.dci;*.hex;*.mcr;*.mcd;*.psx;*.ps2;*.z64;*.n64;*.v64;*.rom;*.sra;*.eep;*.fla;*.mpk;*.gb;*.gbc;*.gba;*.sav;*.nds;*.dsi;*.3ds;*.cci;*.cxi;*.cfa;*.csu;*.app)|*.img;*.bin;*.cue;*.raw;*.imgc;*.iso;*.wbfs;*.zip;*.wud;*.wux;*.gcm;*.gdi;*.cdi;*.cim;*.vmu;*.vms;*.dci;*.hex;*.mcr;*.mcd;*.psx;*.ps2;*.z64;*.n64;*.v64;*.rom;*.sra;*.eep;*.fla;*.mpk;*.gb;*.gbc;*.gba;*.sav;*.nds;*.dsi;*.3ds;*.cci;*.cxi;*.cfa;*.csu;*.app|Switch NAND (*.bin)|*.bin|All files (*.*)|*.*",
    ...
    private void UpdateStatus()
    {
        ...
        StatusTextBlock.Text = ImageKind switch
        {
            ...
            ConsoleDriveImageKind.NintendoWiiWiiU => "Nintendo support detects Wii RVT-H/NAND/disc/WBFS, GameCube FST discs, Wii U WFS/dev storage, Nintendo DS NitroFS ROMs, DSi NAND layouts, and 3DS NCSD/NCCH containers for read-only inspection and carving.",
