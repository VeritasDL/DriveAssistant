...
namespace FATXTools.Database
{
    public class DatabaseFile
    {
        ...
        public DatabaseFile(DirectoryEntry dirent, bool deleted)
        {
            ...
            this.dirent = dirent;
            this.rankingReason = string.Empty;
            this.collisions = new List<uint>();
            this.clusterChain = new List<uint>();
            this.parent = null;
        ...
        public bool HasManualRanking()
        {
            return manualRanking.HasValue;
        }

        public void SetManualRanking(int value)
        {
            manualRanking = value;
        }

        public void ClearManualRanking()
        {
            manualRanking = null;
        }

        public int? GetManualRanking()
        {
            return manualRanking;
        }
        ...
        public void SetRankingReason(string value)
        {
            rankingReason = value;
        }
